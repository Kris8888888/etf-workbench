...
const PRESETS = [
  ...
  {n:'ETF斜率动量轮动', t:['斜率动量', '单持仓', '零成本', '文章复现'], d:'趋势得分 100% · 25 日窗口 · 只持 1 只 · 每日调仓 · 当日收盘成交 · 不计成本',
  ...
  {n:'ETF斜率动量轮动 · 含成本', t:['斜率动量', '单持仓', '含成本'], d:'同「ETF斜率动量轮动」，改成次日收盘成交＋单边 5bp。摩擦一年吃掉约 2 个点',
  ...
  {n:'斜率动量轮动 · 波动降仓', t:['斜率动量', '单持仓', '含成本', '波动目标', '不融资'], d:'四只池、趋势得分不变；挑战者得分要高出阈值才换仓，波动超过目标就按比例降仓，不融资',
  ...
  {n:'斜率动量轮动 · 融资 2 倍', t:['斜率动量', '单持仓', '含成本', '波动目标', '融资'], d:'在「斜率动量轮动 · 波动降仓」之上，波动低于目标时允许融资到 2 倍',
   ex:{q:'「斜率动量轮动 · 波动降仓」把回撤砍了一半，但收益也掉了。文章的第三步：不是无脑加杠杆，而是「安静时借一点力」。',
       h:'把敞口上限从 100% 放到 200%：当实际波动明显低于目标时，目标仓位才会超过 100%；波动一起来就自动收回 1 倍甚至更低。超出部分按 6% 年利率计息。',
       c:'文章给的是年化 35.71%、回撤 16.79%（只比不融资版高不到 1 个点）。我这边复刻出来杠杆是帮倒忙的 —— 它在平静期加仓，而这个池子的平静期后面常跟着急跌。同一个机制换到「低回撤轮动 · 不融资」那个底子上才是正收益，见下面那组。'},
   p:{pool:['518880','513100','159915','510880'], w:{trend:100,mom:0,rs:0,lowvol:0,rev:0},
      win:{trend:25,mom:60,vol:20,rev:5}, topK:1, freq:'D', nDays:20,
      absOn:false, absThresh:0, buffer:0, costBps:5, cashRate:1.5, exec:'next', ...AW0, ...RK0, ...TU0,
  ...
  {n:'ETF双动量轮动', t:['双动量', '单持仓', '零成本', '文章复现'], d:'斜率动量排名 50% ＋ 效率动量排名 50%，综合排名第一的那只 · 当日收盘 · 不计成本',
  ...
  {n:'ETF双动量轮动 · 最少持 3 天', t:['双动量', '单持仓', '零成本', '最小持有'], d:'同「ETF双动量轮动」，买进后至少持 3 个交易日；综合排名跌到第 3 名就不等了',
  ...
  {n:'ETF双动量轮动 · 含成本', t:['双动量', '单持仓', '含成本'], d:'「ETF双动量轮动 · 最少持 3 天」改成次日收盘成交＋单边 5bp，这是双动量诚实的基线',
   ex:{q:'上面两套跟文章一样按当日收盘价成交、不计成本，实盘做不到。',
       h:'规则不变，只换执行口径：当日收盘算信号、次日收盘成交，按换手金额收单边 5bp。',
       c:'跟纯斜率版的「ETF斜率动量轮动 · 含成本」放一起比：双动量多赚 2~3 个点，换手接近，回撤没有改善。它是纯斜率版的一个略好的替代，不是另一种风险特征。'},
   p:{pool:['510880','159915','513100','518880'], w:{trend:50,mom:0,rs:0,lowvol:0,rev:0,eff:50},
      win:{trend:25,mom:60,vol:20,rev:5,eff:20}, combine:'rank', topK:1, freq:'D', nDays:20,
      absOn:false, absThresh:0, buffer:0, costBps:5, cashRate:1.5, exec:'next', ...AW0, ...RK0, ...TU0,
      minHold:3, forceSellRank:3}},
  ...
  {n:'趋势＋低波轮动 · 双持仓', t:['多因子轮动', '双持仓', '含成本', '空仓保护'], d:'趋势 80%／低波 20% · 持 2 只 · 缓冲 1 名 · 趋势转负那份走现金',
  ...
  {n:'趋势＋低波轮动 · 三持仓周频', t:['多因子轮动', '三持仓', '周频', '含成本'], d:'趋势 65%／低波 35% · 池加国债 · 持 3 只 · 每周调仓 · 年换手降到 4 倍上下',
  ...
  {n:'趋势＋低波轮动 · 波动目标', t:['多因子轮动', '三持仓', '周频', '波动目标', '最小持有'], d:'在「趋势＋低波轮动 · 三持仓周频」之上加波动率目标 22% 和 5 日最小持有期。纯轮动里卡玛最高的一套',
  ...
  {n:'趋势＋低波轮动 · 七只广池', t:['多因子轮动', '三持仓', '周频', '波动目标', '分散约束'], d:'七只标的（加小盘、港股） · 相关系数超 0.7 的不同时持 · 波动目标 22%',
  ...
  {n:'低回撤轮动 · 不融资', t:['多因子轮动', '低回撤', '三持仓', '周频', '波动目标', '不融资'], d:'核心五只＋豆粕 · 趋势50／低波50 · 持 3 只 · 周频 · 得分差阈值 0.5 · 波动目标 10%',
  ...
  {n:'低回撤轮动＋海龟', t:['融合', '低回撤', '海龟', '波动目标', '不融资'], d:'「低回撤轮动 · 不融资」70%＋海龟 30%，波动目标 8%，不融资。全工具回撤最小、卡玛最高',
   ex:{q:'「低回撤轮动 · 不融资」已经很稳，但单一逻辑总有失灵的时候。',
       h:'在「低回撤轮动 · 不融资」的基础上分 30% 仓位给海龟腿（破 20 日新高进、破 10 日新低出），每月末重置比例；波动率目标收到 8%。',
  ...
  {n:'低回撤轮动 · 融资 1.5 倍', t:['多因子轮动', '低回撤', '波动目标', '融资'], d:'「低回撤轮动 · 不融资」换 60 日波动窗口、目标 12%，敞口上限放到 150%。全期年化 19%／回撤 9.6%，最接近 20% 的一套',
  ...
  {n:'海龟策略', t:['海龟', '含成本'], d:'不做轮动，只看海龟腿：破 20 日新高进、破 10 日新低出、2 倍 ATR 止损、按 ATR 定头寸',
  ...
  {n:'轮动＋海龟 五五开', t:['融合', '海龟', '多因子轮动'], d:'一半仓位跑轮动，一半仓位跑海龟。两套的进出时点很不一样，混起来回撤明显更小',
  ...
  {n:'全天候策略（风险平价）', t:['全天候'], d:'不做轮动，只看风险平价组合本身长什么样',
  ...
  {n:'轮动＋全天候 五五开', t:['融合', '全天候', '多因子轮动'], d:'一半仓位跑轮动，一半仓位做风险平价底仓（股／债／金），每月再平衡',
  ...
  {n:'轮动＋海龟＋全天候', t:['融合', '海龟', '全天候', '多因子轮动', '低回撤'], d:'轮动 40%＋海龟 30%＋全天候 30%。三段区间实测下来卡玛最高、回撤最小的一套',
